...
class PingPongTableTimeSlotBookAPIView(generics.GenericAPIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            ...
            400: "잘못된 요청 (입력 값 오류, 사용 불가 탁구대, 예약 한도 초과 등)",
            404: "탁구대를 찾을 수 없음",
            409: "동시 예약 시도 충돌 또는 이미 예약된 슬롯",
            500: "서버 내부 오류",
        },
        operation_description=f"탁구대 특정 시간 슬롯 예약. {PING_PONG_SLOT_DURATION_MINUTES}분 또는 {PING_PONG_SLOT_DURATION_MINUTES*2}분 단위로 예약 가능. 하루 최대 1번의 예약 가능",
    )
